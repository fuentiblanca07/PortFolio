...
import TransitionLink from "@/Components/AnimationButton/TransitionLink";
              ...
              <div className="w-full min-h-screen flex items-center justify-center">
                <Card className="w-full lg:w-1/2 border-none rounded-lg shadow-lg z-10 bg-fuchsia-100/15 backdrop-blur-md px-4">
                  <div className="text-center flex flex-col items-center justify-center gap-4 ">
                    ...
                    <h2 className="text-2xl font-semibold text-white">Hi, I'm <span className="text-[rgba(255,255,255,0.45)]">Julius Fuentiblanca</span> </h2>

                    <h1 className="text-4xl font-bold text-white">Experience with<RollingText words={["Developer", "Designer", "Freelancer"]}
            ...
            interval={2500} /></h1>
                ...
                <div className="inline-flex gap-4">
                  <Button variant="outline" className="text-white border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.1)]">
                    <TransitionLink to="/about " onLeave={() => setLeaving(true)}>Let's Get Started</TransitionLink>
                  </Button>
                </div>
